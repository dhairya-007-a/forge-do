// Run: node netlify/selfchecks/_groq-client.selfcheck.js
...
async function run(){
  // 1. First key succeeds — no failover needed.
  {
    ...
    delete require.cache[require.resolve('../functions/_groq-client')];
    const { callGroq } = require('../functions/_groq-client');
