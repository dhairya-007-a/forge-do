...
// works with zero code changes once the Anthropic account has real credits.
  ...
  try{
    const resp = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 350,
        system: systemPrompt,
        messages: [{ role: 'user', content: body.mode === 'backlog' ? 'How do I cover this?' : 'What should I focus on this week?' }]
      })
    });
